...
This repository contains the statistical analysis code, data visualization scripts, and the agentic system architecture associated with the research project:
...
|---|---|
| `Statistical analysis/` | Custom analysis code and methodology used in the study. |
...
# Usage
## Data Visualization
Use the data in `SSource data/` with the plotting code in `Source plot/` to regenerate Figures XX, and Extended Data Figure X.

## Statistical Analysis
The `Statistical analysis/` directory contains the customized code architecture and methodology used in our analysis. Researchers can reference this folder to understand the customized analytical approach. 
