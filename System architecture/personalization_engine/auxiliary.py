...
## Prompt for classifying the user's latest message into a predefined intent.
INTENT_PROMPT = ""  # E.g., "classify the user's latest message into one of the pre-specified intents."
